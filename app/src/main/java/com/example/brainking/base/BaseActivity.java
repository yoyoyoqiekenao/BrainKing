...
import com.example.brainking.action.ActivityAction;
import com.example.brainking.action.BundleAction;
 ...
 * desc   :
 */
public abstract class BaseActivity extends AppCompatActivity implements KeyboardAction, HandlerAction, ActivityAction, ClickAction, BundleAction {
