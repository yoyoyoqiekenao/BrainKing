...
import com.example.brainking.view.EasyProgressDialog;
 ...
 * desc   :
 */
public class RequestLoadingUtils {
    ...
    public static EasyProgressDialog showProgressDialog(Context context, String message, DialogInterface.OnCancelListener listener) {
